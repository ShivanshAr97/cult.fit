            ...
            <div className=''>
                <div className='flex fixed bottom-6 right-4 border p-2 rounded w-1/4 bg-white z-10 drop-shadow-lg'>
                    ...
                    <div className='py-2 px-4'>
                        <p className='absolute top-1 right-2 text-gray-500 cursor-pointer'><i class="fa-solid fa-sm fa-xmark"></i></p>
                        <h1 className='text-sm font-bold hover:underline'>What Is Stamina And How To Increase Yours</h1>
