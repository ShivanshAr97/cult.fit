            ...
            <div className='mx-4'>
                ...
                <div className='flex mx-4'>
                    <div className='w-11/12'>
                        <img className='rounded-lg w-11/12 my-3 cursor-pointer hover:scale-110 translate-x-4 ease-in duration-300' src="https://global-uploads.webflow.com/5fe33d036237252135e3e74d/62a9a67a0ffd93752cff6fe8_BoxingForWeightLoss_32.jpg" alt="" />
                    ...
                    <div className='w-11/12'>
                        <img className='rounded-lg w-11/12 my-3 cursor-pointer hover:scale-110 translate-x-4 ease-in duration-300' src="https://global-uploads.webflow.com/5fe33d036237252135e3e74d/625427506f62da000c3b130d_Yoga-for-Weight-%26-Fat-Loss_10.jpg" alt="" />
                        <h2 className='mx-4 font-bold text-lg hover:underline'>Lorem ipsum dolor sit amet.</h2>
                        <p className='m-4 text-gray-500 text-xs spacing-2'><i class="fa-solid fa-calendar"></i>&nbsp; 24 May, 2022 &nbsp; &nbsp; | &nbsp; &nbsp; <i class="fa-solid fa-clock"></i>&nbsp; 5 min read</p>
                    </div>
                    <div className='w-11/12'>
                        <img className='rounded-lg w-11/12 my-3 cursor-pointer hover:scale-110 translate-x-4 ease-in duration-300' src="https://global-uploads.webflow.com/5fe33d036237252135e3e74d/61f775c88286b05a9be92c05_WaterWeight_1200x800.jpg" alt="" />
                        <h2 className='mx-4 font-bold text-lg hover:underline'>Lorem ipsum dolor sit amet.</h2>
                        <p className='m-4 text-gray-500 text-xs spacing-2'><i class="fa-solid fa-calendar"></i>&nbsp; 24 May, 2022 &nbsp; &nbsp; | &nbsp; &nbsp; <i class="fa-solid fa-clock"></i>&nbsp; 5 min read</p>
                    </div>
